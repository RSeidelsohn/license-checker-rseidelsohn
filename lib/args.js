 ...
 * @property {Object=} customFormat Custom output fields and default values.
 ...
 * @property {boolean=} onlyunknownOpts Only list packages with unknown or guessed licenses.
 ...
 * @property {boolean=} unknownOpts Report guessed licenses as unknown licenses.
...
function toDepthNumber(value = Number.POSITIVE_INFINITY) {
	...
	switch (typeof value) {
		case 'string':
			...
			break;
		case 'boolean':
			numberValue = value ? Number.POSITIVE_INFINITY : 0;
			break;
		case 'number':
