 ...
 * @returns Number
 */
const toDepthNumber = function toDepthNumber(value = Number.POSITIVE_INFINITY) {
	let numberValue = 0;
...
export { getNormalizedArguments, knownOptions, parseArguments, setDefaultArguments };
