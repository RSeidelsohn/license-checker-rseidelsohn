...
exports.init = function init(args, callback) {
    ...
    read(args.start, opts, (err, json) => {
        ...
        function excludePackagesEndingWith(blacklist, filtered) {
            const resultJson = {};
        ...
        // exclude by package name ending with a string
        const excludeEndString = getOptionArray(args.excludePackagesStartingWith);
        if (excludeEndString) {
            resultJson = excludePackagesEndingWith(excludeEndString, filtered);
        }
