...
exports.init = function init(args, callback) {
    ...
    read(args.start, opts, (err, json) => {
        ...
        const regexString = getOptionArray(args.excludeRegex);
        if (regexString) {
            const regex = new RegExp(regexString);
            console.log(`Excluding packages matching regex: ${regexString}`);
            console.log('Excluding packages matching regex: ', regex);
        }
