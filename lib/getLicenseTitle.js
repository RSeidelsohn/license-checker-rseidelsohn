...
export const getLicenseTitle = (str = 'undefined') => {
	if (typeof str !== 'string') {
		throw new Error(`Wrong type for parameter "str" ("${str}"): Must be of type string`, 'lib/getLicenseTitle.js', 24);
	}
	...
	if (str) {
		// biome-ignore lint/style/noParameterAssign: TODO this whole function is a bit funky, and I'm too lazy to clean this up NOW :D
		str = str.replace('\n', '');
	}
